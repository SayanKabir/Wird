...
class SunnahRepository {
  ...
  static const _seeds = <_S>[
    ...
    _S(cat: 'Eating & Drinking', t: 'Eat from what is nearest to you', ref: 'Bukhari 5376', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ told a young boy: "O boy, say Bismillah, eat with your right hand, and eat from what is nearest to you." (Bukhari 5376)', vir: 'Shows good manners and consideration for others sharing the meal.'),
    _S(cat: 'Eating & Drinking', t: 'Eat with three fingers', ref: 'Muslim 2032', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ used to eat with three fingers and would lick them before wiping them. (Muslim 2032)', vir: 'Eating moderately and with humility mirrors the Prophetic way.'),
    ...
    _S(cat: 'Eating & Drinking', t: 'Lick fingers before wiping', ref: 'Muslim 2031', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "When any of you eats, let him not wipe his fingers until he has licked them." (Muslim 2031)', vir: 'Shows respect for the blessing of food and avoids waste.'),
    ...
    _S(cat: 'Eating & Drinking', t: 'Drink in three breaths', ref: 'Bukhari 5631, Muslim 2028', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ used to breathe three times while drinking, removing the vessel from his mouth each time. (Muslim 2028)', vir: 'More satisfying, healthier, and a beautiful sunnah to revive.'),
    _S(cat: 'Eating & Drinking', t: 'Say Bismillah when drinking', ref: 'Ibn Majah 3264', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'Say Bismillah before drinking, just as before eating. (Ibn Majah 3264)', vir: 'Remembering Allah before every blessing sanctifies the act.'),
    _S(cat: 'Eating & Drinking', t: 'Cover utensils at night', ref: 'Bukhari 5623, Muslim 2013', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "Cover your utensils and tie your water-skins." (Bukhari 5623)', vir: 'Protects from impurities and follows Prophetic hygiene.'),
    _S(cat: 'Eating & Drinking', t: "Don't blow into food/drink", ref: 'Abu Dawud 3728, Tirmidhi 1888', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ forbade blowing into food and drink. (Abu Dawud 3728)', vir: 'Maintains cleanliness and respect for shared food.'),
    ...
    _S(cat: 'Eating & Drinking', t: "Don't eat while reclining", ref: 'Bukhari 5398', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "I do not eat while reclining." (Bukhari 5398)', vir: 'Eating upright aids digestion and shows humility.'),
    ...
    _S(cat: 'Personal Hygiene', t: 'Comb hair', ref: 'Muslim 2076', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ encouraged combing hair and maintaining grooming. (Muslim 2076)', vir: 'Neatness and grooming are part of Islamic character.'),
    _S(cat: 'Personal Hygiene', t: 'Part hair on the right', ref: 'Abu Dawud 4148', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ loved to start from the right in all matters. (Abu Dawud 4148)', vir: 'Starting from the right is a consistent sunnah in grooming.'),
    ...
    _S(cat: 'Personal Hygiene', t: 'Wash hands before/after meals', ref: 'Tirmidhi 1846', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ would wash his hands before and after eating. (Tirmidhi 1846)', vir: 'Basic hygiene and a forgotten sunnah.'),
    _S(cat: 'Personal Hygiene', t: 'Make wudu before sleep', ref: 'Bukhari 247, Muslim 2710', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "When you go to bed, perform wudu as you would for prayer." (Bukhari 247)', vir: 'Sleeping in a state of purity brings angelic protection.'),
    _S(cat: 'Personal Hygiene', t: 'Enter bathroom with left foot', ref: 'Ibn Majah 301', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'Enter the bathroom with the left foot. (Ibn Majah 301)', vir: 'Maintaining adab in all aspects of life.'),
    _S(cat: 'Personal Hygiene', t: 'Exit bathroom with right foot', ref: 'Ibn Majah 301', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'Exit the bathroom with the right foot. (Ibn Majah 301)', vir: 'The right side is preferred for all clean and good actions.'),
    ...
    _S(cat: 'Personal Hygiene', t: 'Use water for istinja (cleaning)', ref: 'Muslim 271', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ used water for cleaning after relieving himself. (Muslim 271)', vir: 'Water-based cleaning is the most thorough method.'),
    _S(cat: 'Personal Hygiene', t: 'Use left hand in bathroom', ref: 'Bukhari 153', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ would use his left hand for cleaning in the bathroom. (Bukhari 153)', vir: 'Reserving the right hand for eating and clean actions.'),
    _S(cat: 'Personal Hygiene', t: "Don't talk in bathroom", ref: 'Abu Dawud 15, Tirmidhi 7', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ disliked speaking while relieving oneself. (Abu Dawud 15)', vir: 'Maintaining focus and avoiding mention of Allah in unclean places.'),
    ...
    _S(cat: 'Social Etiquette & Character', t: 'Be merciful to youngsters', ref: 'Bukhari 5997, Muslim 2318', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ kissed his grandson and a man said "I have ten children and never kissed any of them." The Prophet ﷺ replied: "He who is not merciful will not be shown mercy."', vir: 'Showing mercy to children brings Allah\'s mercy upon you.'),
    ...
    _S(cat: 'Social Etiquette & Character', t: "Don't interrupt others", ref: 'Tirmidhi 2018', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The companions would not interrupt each other, and the Prophet ﷺ would listen attentively. (Tirmidhi 2018)', vir: 'Good listening is a sign of respect and wisdom.'),
    _S(cat: 'Social Etiquette & Character', t: 'Reconcile between people', ref: 'Bukhari 2692, Muslim 2623', g: 'Sahih', diff: SunnahDifficulty.medium, freq: SunnahFrequency.occasional, desc: 'The Prophet ﷺ said: "Shall I not tell you what is better than fasting, prayer, and charity? — Reconciling between people." (Abu Dawud 4919)', vir: 'Reconciliation is better than extra fasting and prayer.'),
    _S(cat: 'Social Etiquette & Character', t: 'Keep good company', ref: 'Bukhari 5534, Muslim 2628', g: 'Sahih', diff: SunnahDifficulty.medium, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "A person is upon the religion of his friend, so let each one of you look at whom he befriends." (Abu Dawud 4833)', vir: 'Good company strengthens your faith and character.'),
    ...
    _S(cat: 'Sleep & Waking', t: 'Place right hand under cheek', ref: 'Bukhari 6314, Abu Dawud 5045', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ used to place his right hand under his right cheek when going to sleep. (Abu Dawud 5045)', vir: 'A simple, beautiful sunnah that connects you to the Prophet ﷺ.'),
    ...
    _S(cat: 'Sleep & Waking', t: 'Dust bed three times before sleeping', ref: 'Bukhari 6320, Abu Dawud 5050', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "When any of you goes to his bed, let him dust it off three times." (Bukhari 6320)', vir: 'A hygienic sunnah that also removes unseen harms.'),
    ...
    _S(cat: 'Fasting', t: 'Make dua when breaking fast', ref: 'Tirmidhi 3456, Ibn Majah 1753', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.occasional, desc: 'The Prophet ﷺ said: "The dua of the fasting person at iftar is not rejected." (Tirmidhi 3456)', vir: 'A guaranteed moment of accepted dua.'),
    ...
    _S(cat: 'Family & Relationships', t: 'Treat in-laws well', ref: 'Bukhari 3110', g: 'Sahih', diff: SunnahDifficulty.medium, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ treated his wives\' families with respect and kindness. (Bukhari 3110)', vir: 'Good relationships with in-laws strengthen the family unit.'),
    ...
    _S(cat: 'Travel', t: 'Say Allahu Akbar ascending, SubhanAllah descending', ref: 'Bukhari 2993', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.occasional, desc: 'The Prophet ﷺ and companions would say Allahu Akbar going uphill and SubhanAllah descending. (Bukhari 2993)', vir: 'Remembering Allah during every part of the journey.'),
    ...
    // ━━━━━━━━━━━━━━━ MISCELLANEOUS (8) ━━━━━━━━━━━━━━━
    _S(cat: 'Miscellaneous Daily Sunnahs', t: 'Say Bismillah before starting anything', ref: 'Abu Dawud 101, Tirmidhi 1856', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "Every significant act that does not begin with Bismillah is deprived of blessing." (Ibn Majah 1894)', vir: 'Bismillah invites barakah into every action.'),
    _S(cat: 'Miscellaneous Daily Sunnahs', t: 'Wear shoes starting with the right', ref: 'Bukhari 5855, Muslim 2097', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "When any of you puts on shoes, let him start with the right; and when removing, start with the left." (Bukhari 5855)', vir: 'Prioritizing the right follows the Prophetic way in daily habits.'),
    _S(cat: 'Miscellaneous Daily Sunnahs', t: 'Dress starting with the right side', ref: 'Muslim 2097', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ loved to start from the right in putting on his clothes. (Muslim 2097)', vir: 'A simple daily sunnah in dressing.'),
    ...
    _S(cat: 'Miscellaneous Daily Sunnahs', t: 'Say Alhamdulillah when sneezing', ref: 'Bukhari 6224', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "When one of you sneezes, let him say Alhamdulillah." (Bukhari 6224)', vir: 'Praising Allah for the blessing of sneezing.'),
    _S(cat: 'Miscellaneous Daily Sunnahs', t: 'Say dua when looking in mirror', ref: 'Tirmidhi 3453', g: 'Hasan', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ would say: "Allahumma ahsanta khalqi fa ahsin khuluqi." (Tirmidhi 3453)', vir: 'Asking Allah to beautify your character as He beautified you.', arabic: 'اللَّهُمَّ أَحْسَنْتَ خَلْقِي فَأَحْسِنْ خُلُقِي', translit: 'Allahumma ahsanta khalqi fa ahsin khuluqi', transl: 'O Allah, as You made my appearance good, make my character good too.'),
    _S(cat: 'Miscellaneous Daily Sunnahs', t: 'Use right hand for good things', ref: 'Muslim 267', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ used his right hand for eating, drinking, and giving, and his left for the opposite. (Muslim 267)', vir: 'Reserving the right for good and clean actions.'),
    _S(cat: 'Miscellaneous Daily Sunnahs', t: 'Keep environment clean', ref: 'Muslim 269', g: 'Sahih', diff: SunnahDifficulty.easy, freq: SunnahFrequency.daily, desc: 'The Prophet ﷺ said: "Cleanliness is half of faith." (Muslim 223)', vir: 'A clean environment reflects a clean heart.'),
  ];
}
